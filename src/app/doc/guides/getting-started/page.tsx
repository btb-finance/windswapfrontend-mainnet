  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 lg:py-12">
        <Link href="/doc" className="text-blue-400 hover:text-blue-300 mb-6 sm:mb-8 inline-block text-sm sm:text-base">
          &larr; Back to Documentation
        </Link>

        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-green-400 to-blue-600 bg-clip-text text-transparent">
          Getting Started with Wind Swap
        </h1>
        <p className="text-sm sm:text-base lg:text-xl text-gray-400 mb-8 sm:mb-12">
        ...
        <div className="space-y-5 sm:space-y-8">
          ...
          <GuideStep step={1} title="Get WIND Tokens">
            ...
            <div className="bg-gray-800 rounded-lg p-4 sm:p-5 space-y-3">
              <ActionItem
                title="Buy on DEX"
          ...
          {/* Step 2 */}
          <GuideStep step={2} title="Lock WIND for veNFT">
            <p className="text-gray-300 mb-4 text-sm sm:text-base">
              Create a Vote-Escrowed NFT to establish long-term passive income. Lock WIND for 4-5 years
              and earn weekly rewards indefinitely.
            </p>
            <div className="bg-gray-800 rounded-lg p-4 sm:p-5 mb-4">
              <h4 className="font-bold mb-3 text-purple-400 text-sm sm:text-base">Lock Parameters</h4>
              <ul className="space-y-2 text-gray-300 text-sm sm:text-base">
                <li>• <strong>Amount:</strong> How many WIND to lock</li>
                <li>• <strong>Duration:</strong> Lock time (1 week to 4 years)</li>
                <li>• <strong>Voting Power:</strong> Amount x Lock Time</li>
              </ul>
            </div>
            <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4 mb-4">
              <p className="text-blue-200 text-sm sm:text-base">
                <strong>Long-Term Strategy:</strong> Lock WIND for maximum duration (4 years) to create sustainable
                passive income. Your veNFT will earn weekly rebases plus you can vote for pools to earn bribes
                and trading fees. You can sell your veNFT anytime on NFT marketplaces if you need liquidity.
              </p>
            </div>
            <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4">
              <h4 className="font-bold mb-2 text-green-300 text-sm sm:text-base">Passive Income Breakdown</h4>
          ...
          <GuideStep step={4} title="Voting for Pools">
            ...
            <div className="bg-gray-800 rounded-lg p-4 sm:p-5 mb-4">
              <h4 className="font-bold mb-3 text-yellow-400 text-sm sm:text-base">Weekly Voting Process</h4>
              <ol className="space-y-3 text-gray-300 text-sm sm:text-base">
                <li className="flex gap-3">
                  <span className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-yellow-600 flex items-center justify-center font-bold text-xs sm:text-sm">1</span>
                  <div><strong>Research:</strong> Check bribe amounts and fee potential</div>
                </li>
                <li className="flex gap-3">
                  <span className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-yellow-600 flex items-center justify-center font-bold text-xs sm:text-sm">2</span>
                  <div><strong>Vote:</strong> Allocate your voting power to chosen pools (max 30)</div>
                </li>
                <li className="flex gap-3">
                  <span className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-yellow-600 flex items-center justify-center font-bold text-xs sm:text-sm">3</span>
                  <div><strong>Wait:</strong> Voting ends at epoch close (Thursday midnight UTC)</div>
                </li>
                <li className="flex gap-3">
                  <span className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-yellow-600 flex items-center justify-center font-bold text-xs sm:text-sm">4</span>
                  <div><strong>Claim:</strong> Collect rewards from previous week's votes</div>
                </li>
              </ol>
            </div>
          ...
          {/* Step 5 */}
          <GuideStep step={5} title="Providing Liquidity">
            <p className="text-gray-300 mb-4 text-sm sm:text-base">
            ...
            <div className="space-y-4">
              <div className="bg-gray-800 rounded-lg p-4 sm:p-5">
                <h4 className="font-bold mb-3 text-green-400 text-sm sm:text-base">V2 Liquidity</h4>
              ...
              <div className="bg-gray-800 rounded-lg p-4 sm:p-5">
                <h4 className="font-bold mb-3 text-blue-400 text-sm sm:text-base">V3 Liquidity</h4>
                <ul className="space-y-2 text-gray-300 text-sm">
          ...
          <GuideStep step={6} title="Claiming Rewards">
            <p className="text-gray-300 mb-4 text-sm sm:text-base">
              Claim your earned rewards regularly:
            </p>
            <div className="bg-gray-800 rounded-lg p-4 sm:p-5 space-y-4">
              <RewardTypeCard
                title="Voter Rewards"
          ...
          {/* Advanced Tips */}
          <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 rounded-lg p-4 sm:p-6 border border-purple-500/30">
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-4 text-purple-400">Advanced Strategies</h3>
            <div className="space-y-4">
              <TipCard
          ...
          <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4 sm:p-6">
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-4 text-red-400">Security Best Practices</h3>
            <ul className="space-y-2 text-gray-300 text-sm sm:text-base">
              ...
              <li>• Keep your veNFT secure - it holds real value</li>
          ...
          <div className="bg-gray-800 rounded-lg p-4 sm:p-6">
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-4 text-blue-400">Additional Resources</h3>
            <div className="grid sm:grid-cols-2 gap-4">
              <ResourceLink
              ...
              />
              <ResourceLink
                title="BaseScan Explorer"
                href="https://basescan.org"
                description="View transactions and contracts on Base"
              />
              <ResourceLink
        ...
        <div className="mt-10 sm:mt-12 text-center text-gray-400 text-sm sm:text-base">
  ...
  return (
    <div className="bg-gray-800/50 rounded-lg p-4 sm:p-6 border border-gray-700">
      <div className="flex items-center gap-3 sm:gap-4 mb-4">
        <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-base sm:text-xl font-bold shrink-0">
          {step}
        </div>
        <h2 className="text-base sm:text-xl lg:text-2xl font-bold">{title}</h2>
      </div>
      <div>{children}</div>
    </div>
  );
...
function ActionItem({ title, description }: { title: string; description: string }) {
  return (
    <div className="flex gap-3">
      ...
      <div>
        <h4 className="font-semibold text-blue-400 text-sm sm:text-base">{title}</h4>
...
function StrategyCard({ title, label, description, steps }: { title: string; label: string; description: string; steps: string[] }) {
  return (
    <div className="bg-gray-700 rounded-lg p-4 sm:p-5">
      <div className="flex items-center gap-2 mb-2">
        <h4 className="font-bold text-base sm:text-lg">{title}</h4>
        <span className="text-xs bg-blue-600/40 text-blue-300 px-2 py-0.5 rounded-full">{label}</span>
      </div>
...
function RewardTypeCard({ title, types, frequency }: { title: string; types: string[]; frequency: string }) {
  return (
    <div className="bg-gray-700/50 rounded p-4">
      <h4 className="font-bold mb-2 text-sm sm:text-base">{title}</h4>
      <ul className="text-xs sm:text-sm text-gray-300 mb-2">
        {types.map((t, i) => (
          <li key={i}>• {t}</li>
        ))}
      </ul>
...
function TipCard({ title, description, risk }: { title: string; description: string; risk: string }) {
  return (
    <div className="bg-gray-800/50 rounded p-4">
      <h4 className="font-bold text-purple-300 mb-1 text-sm sm:text-base">{title}</h4>
      <p className="text-xs sm:text-sm text-gray-300 mb-2">{description}</p>
      <p className="text-xs text-red-400">Risk: {risk}</p>
    </div>
  );
}
...
function ResourceLink({ title, href, description }: { title: string; href: string; description: string }) {
  return (
    <a href={href} className="block bg-gray-700 rounded p-4 hover:bg-gray-600 transition">
      <h4 className="font-bold text-blue-400 mb-1 text-sm sm:text-base">{title}</h4>
      <p className="text-xs sm:text-sm text-gray-400">{description}</p>
    </a>
  );
}
